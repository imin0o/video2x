...
作成日：2026-09-13。計画版：v1.1。状態：M3実装と技術検証完了、R16とR17の制作者受入待ち。進捗更新日：2026-09-14。
...
全体進捗：**15 / 23件完了（65.2%）**。チェックは各タスクの完了条件を満たした時点で付ける。
...
- [ ] R16：等倍と拡大、時刻、色変換、音声を含む出力契約を実装する。
  - 依存：R11、R14。2026-09-14実装と技術検証完了。等倍と拡大、VFR、短い末尾、PCM音声同期、等倍での原像復帰を確認。A07の制作者によるちらつき確認待ち。[比較動画](../build/art/m3-verified/comparison.mp4)、[M3記録](art-tool-m3.md)。
- [ ] R17：進捗、取消、失敗記録と処理時間の測定を整える。
  - 依存：R15、R16。2026-09-14実装と技術検証完了。58テストとGPUで取消、注入例外、再起動後の再生成を確認。5秒の出力441.2秒、単フレーム3.90秒、取消38.8ms。A09の許容待ち時間は制作者の判断待ち。[M3記録](art-tool-m3.md)、[検証結果](../build/art/m3-verified/summary.json)。
