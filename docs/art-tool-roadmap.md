...
- [x] R10：同一素材の比較を制作者と評価する。
  - 完了：2026-09-13。制作者の「いい感じ。R10完了扱いでOK」によりA01・A02とM1受入を承認。元の色を保ち、細部と輪郭を強く崩す`melt-16`（標準）と`melt-24`（強め）を採用。初回候補は表現不足、極彩色の中間結果は色の方針に合わず見送り。2候補×5秒300フレーム、画素一致と元データ保全、テスト20件を確認。[比較とレシピ](../build/art/m1-source-color/index.html)、[承認記録](../build/art/m1-source-color/review.json)。
